...
def plot_yield():
    ...
    if(not NO_HMS):
        ...
        coefficients = np.polyfit(yield_data["current"], yield_data["yieldRel_HMS_scaler"], 1)
        poly = np.poly1d(coefficients)
        plt.plot(yield_data["current"], poly(yield_data["current"]), color='green', label='Line of Best Fit')
        print(poly)
        print("_____________________________________--------------------------___________________--------------------------------")
