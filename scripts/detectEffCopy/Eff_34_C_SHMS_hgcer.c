...
gr->SetTitle("SHMS Carbon Heavy Gas Cerenkov Efficiency vs EL-Real Trigger Rate");
gr->SetMarkerColor(4);
gr->SetMarkerStyle(21);
gr->GetXaxis()->SetTitle("EL-Real Trigger Rate (KHz)");
gr->GetYaxis()->SetTitle("Heavy Gas Cerenkov Efficiency");
...
gr->Draw("");
c1->Print("Eff_34_SHMS_C_hgcer.png","png");
